...
arts_exe = os.path.join(os.environ['HOME'],
                        'Hacking/arts-build/clang-debug/src/arts')

stdout = typhon.arts.run_arts(
    controlfile='TestHitranXsec.arts', arts=arts_exe)[1]
print(stdout)
